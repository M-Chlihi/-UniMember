...
export default function VoteConfirmationModal({ open, optionTitle, onClose }) {
  if (!open) {
    return null;
  }
    ...
    >
      ...
      >
        <div className="text-center">
          <div className="mx-auto flex size-12 items-center justify-center rounded-full bg-green-50 text-green-700">
            ✓
          </div>
